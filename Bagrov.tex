...
\captionstyle{normal}\caption{Метод деления пополам (метод бисекции)}\label{fig:dq_rime_wet}
\end{figure}
...
\captionstyle{normal}\caption{Метод хорд}\label{fig:chords}
\end{figure}
...
\captionstyle{normal}\caption{Метод Ньютона}\label{fig:newton}
\end{figure}
...
\captionstyle{normal}\caption{Распределение количества обращений к значениям функции для ее решения для исследуемых методов}\label{fig:calls}
\end{figure}
...
\captionstyle{normal}\caption{Распределение итераций для исследуемых методов}\label{fig:iterations}
\end{figure}
